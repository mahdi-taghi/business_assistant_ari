  ...
  return (
    <div className={`min-h-screen flex items-center justify-center px-4 py-10 ${
      ...
      <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className={`rounded-3xl shadow-2xl backdrop-blur-xl p-8 sm:p-10 order-last lg:order-first ${
          isDark 
          ...
          <div className="mb-8 text-center space-y-2">
            ...
            }`}>حساب کاربری خود را بسازید</h2>
            <p className={`text-sm text-justify text-right ${
              isDark ? 'text-slate-400' : 'text-slate-600'
            }`}>چند جزئیات به اشتراک بگذارید تا بتوانیم فضای کاری هوشمند شما را شخصی‌سازی کنیم.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            >
              <span className="text-right">{isSubmitting ? "در حال ثبت نام..." : "ایجاد حساب"}</span>
            </Button>
          </form>

          <div className={`mt-6 text-xs text-center text-justify text-right ${
        ...
        <div className={`flex flex-col justify-center space-y-6 max-lg:text-center ${
          isDark ? 'text-white' : 'text-slate-800'
        }`}>
          <div className="flex items-center gap-3 justify-center lg:justify-start">
            ...
            <div className="text-left">
              ...
              <h1 className="text-3xl font-bold text-right">فضای کاری هوشمند شخصی‌سازی شده</h1>
            </div>
          </div>
          ...
          <div className={`flex items-start gap-3 max-lg:justify-center ${
            isDark ? 'text-slate-300' : 'text-slate-600'
          }`}>
            <Sparkles className="w-5 h-5 text-purple-400 mt-1" />
            <ul className="space-y-2 text-sm text-left text-justify text-right">
